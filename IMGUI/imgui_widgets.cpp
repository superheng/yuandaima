...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (ImGui::IsItemHovered())
        Color = ImGui::GetColorU32(ImLerp(ImVec4(0.26f, 0.59f, 0.98f, 0.67f), ImVec4(0.5f, 0.5f, 0.50f, 1.0f), t));
    else
        Color = ImGui::GetColorU32(ImLerp(ImVec4(0.5f, 0.5f, 0.50f, 1.0f), ImVec4(0.26f, 0.59f, 0.98f, 0.67f), t));
    // 组件绘制
